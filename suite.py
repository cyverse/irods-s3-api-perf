...
TestFactory objects, one for each action being performed, and a Recorder
object, where results are sent. The PerformanceSuite uses these TestFactory
objects to create Test objects. A Test measures the time it takes a single
Tool to perform a certain action once.
"""
